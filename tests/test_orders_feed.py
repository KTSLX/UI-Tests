...
class TestOrdersFeed:
    ...
    def test_display_new_order_in_orders_feed(self, driver, register_user):
        ...
        main_page.set_authorization(register_user['token'])
    ...
    def test_orders_counter(self, driver, counter_name, register_user):
        main_page = MainPage(driver)
        orders_feed_page = OrdersFeedPage(driver)
    ...
    def test_show_order_number_in_work(self, driver, register_user):
        main_page = MainPage(driver)
        orders_feed_page = OrdersFeedPage(driver)
